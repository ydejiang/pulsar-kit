...
#
##---
# The following is modified by Yin
#
        ...
        for ii,(lo,hi) in enumerate(tempo_results.freqbands):
            ...
            if len(xdata):
                ...
                handle = plt.errorbar(xdata, ydata, yerr=yerr, fmt='.', \
                                      ...
                                      #c=colors[len(tempo_results.freqbands)][ii], ms=9, capsize=4.5, elinewidth=1.2, markeredgecolor='k', markeredgewidth=0.1)
                                      c=colors[len(tempo_results.freqbands)][ii], ms=6, capsize=0.5, elinewidth=.95)
