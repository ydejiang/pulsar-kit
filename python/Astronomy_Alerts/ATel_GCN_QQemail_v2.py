...
DEFAULT_EMAIL = "demo@qq.com"               # Default QQ email address
#DEFAULT_PASSWORD = "....zdkqifhj"         # Default authorization code
DEFAULT_PASSWORD = "....vmchfh" 
...
def generate_combined_email(atels, gcns):
    ...
    for atel in atels:
        ...
        atel_content.append(
            f"""<details style="margin:0 0 4px 0;padding:0;">
<summary style="margin:0;padding:0;line-height:1.1;cursor:pointer;">#{atel['num']}. <a href="{atel['url']}" style="text-decoration:none;">{html.escape(atel['title'])}</a></summary><div style="
...
{html.escape(full_text)}
    ...
    for gcn in gcns:
        ...
        gcn_content.append(
        f"""<details style="margin:0 0 4px 0;padding:0;">
<summary style="margin:0;padding:0;line-height:1.1;cursor:pointer;">#{gcn['num']}. <a href="{gcn['url']}" style="text-decoration:none;">{html.escape(gcn['subject'])}</a></summary><div style="
white-space:pre-line;
font-family:Arial,sans-serif;
font-size:15px;
line-height:1.3;
