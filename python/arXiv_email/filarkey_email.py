        ...
        for i in range(len(lines_abstracts)):
            if any(word in lines_abstracts[i] for word in all_keywords):
                ...
                f.write(
                    ...
                    <summary style="cursor: pointer; font-size: 1.2em; color: blue;">
...
def send_email_html_report(
    ...
    msg['Subject'] = f"arXiv astro-ph daily report ({date_str})"
...
def main():
    ...
    sender_password = "fplkgcpl****"   # QQ Mail authorization code
    receiver_emails = ["20251216@qq.com", "demo@qq.com", "demo@foxmail.com"]
