  ...
  <tr>
    <td>
      <details><summary><code>update log</code></summary>
        ...
        9. <code>ATNFCAT_PSRcat_download.ipynb</code>; a simple PulsarCAT download tutorial with the `psrqpy` package (https://psrqpy.readthedocs.io/en/latest/index.html).<br>
        ...
      </details>
    </td>
  </tr>
