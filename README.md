...
3. `FAST_tracking.py`; this script calculates and plots the altitude tracks (also tracking time) of celestial sources observed by the Five-hundred-meter Aperture Spherical radio Telescope (FAST) for a given date and specified source(s).
